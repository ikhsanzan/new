...
$dataproduk = query("SELECT * FROM `users` ");
...
<body>
    ...
    <!-- Content -->
    <h4 class="display-5 pt-4 text-center" style="font-family: 'Open Sans', sans-serif; font-weight: bold;"> Halaman Data Pelanggan</h4>
    ...
    <div class="container-fluid mt-4">
        ...
        <button type="button" class="btn btn-primary mb-3 ">Tambah Data Pengguna</button>
        </a>
                    ...
                    <?php foreach ($dataproduk as $produk) : ?>
                        <tr>
                            ...
                            <td class="no-border-right" style="text-align: center; border-right: none;">
                                <a href="edit-data-pengguna.php?id=<?= $produk["id"] ?>" class="mr-2">Ubah</a>
                            </td>
    ...
    <script src="js/data-pengguna.js"></script>
